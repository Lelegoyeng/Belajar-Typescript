...
class AddressService {
    ...
    static checkAddressMustExistx(contactId, addressId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static get(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield contact_service_1.ContactService.checkContactMustExists(user.username, request.contact_id);
            const address = yield this.checkAddressMustExistx(getRequest.contact_id, getRequest.id);
            return (0, address_model_1.toAddressResponse)(address);
        });
    }
    static update(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield contact_service_1.ContactService.checkContactMustExists(user.username, request.contact_id);
            yield this.checkAddressMustExistx(updateRequest.contact_id, updateRequest.id);
    ...
    static remove(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield contact_service_1.ContactService.checkContactMustExists(user.username, request.contact_id);
            yield this.checkAddressMustExistx(removeRequest.contact_id, removeRequest.id);
