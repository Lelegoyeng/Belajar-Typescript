...
describe("POST /api/contacts", () => {
  ...
  it("should create new contact", async () => {
    ...
    expect(response.body.data.first_name).toBe("kevin");
    expect(response.body.data.last_name).toBe("lelegoyeng");
    expect(response.body.data.email).toBe("kevin@example.com");
