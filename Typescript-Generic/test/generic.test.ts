describe("generic", () => {
  ...
  it("should create simple generic", async () => {
    ...
    simple.setValue("Kevin");
    // simple.setValue(100);
    // simple.setValue(true);

    expect(simple.getValue()!.toUpperCase()).toBe("KEVIN");
  });
